...
1. Create **AI Search** resource with the below provided configuration details:
   ...
   - **Location:** **<inject key="Region"></inject>** or any other available region (should be same as the region where the Foundry project is created)
...
1. Note the **URL** from the Overview page and the **Primary admin key** from Settings → Keys. You will need these in Challenge 03.
