...
1. Navigate back to the **Microsoft Foundry portal**. Open your **project** and copy the **Project endpoint** URL from the Overview page.

   > **Note:** The Project endpoint has the format: `https://<resource-name>.services.ai.azure.com/api/projects/<project-name>`.

1. From the **Azure Portal**, open your **Azure AI Search** resource. Copy the **URL** from the Overview page and the **Primary admin key** from Settings → Keys.
...
1. Replace the placeholder values in the `.env` file:
