...
1. On the AI Search **Overview** page, note the **URL** (e.g., `https://aisearch-xxxx.search.windows.net`). You will need this later.

1. In the left menu, go to **Settings → Keys**. Copy the **Primary admin key**. You will need this later.
