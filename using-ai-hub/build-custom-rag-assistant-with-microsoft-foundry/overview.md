...
- Create and configure Microsoft Foundry Hub and Project resources
...
- **Challenge 01: Create Microsoft Foundry Hub and Project**  
  Provision the Microsoft Foundry hub and create a project that will manage AI models and integrations.
...
You will begin by provisioning a Microsoft Foundry Hub and Project, which will serve as the central environment for managing AI resources. Next, you will deploy Azure OpenAI models and configure Azure AI Search to act as the vector database for storing and retrieving knowledge embeddings.
